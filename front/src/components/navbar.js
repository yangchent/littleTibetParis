        ...
        <nav className='sticky top-0 z-50 bg-white'>
            ...
            <div className="md:flex md:justify-center hidden">
                <div className="flex">
                    <div className="flex space-x-2 lg:space-x-8 items-center text-sm lg:text-md">
                        ...
                        <Link to="/about" className="py-4 px-2 whitespace-nowrap font-poppins font-semibold hover:text-mygreen transition duration-300">À PROPOS DE</Link>
            ...
            <aside className={`z-10 absolute top-0 3/4 bg-white rounded -translate-x-full flex flex-col overflow-hidden ${openNav === true ? 'translate-x-0 transform transition duration-500 ease-in-out' : '-translate-x-full transform transition duration-500 ease-in-out'}`}>
                ...
                <div className='flex flex-col px-4 mt-4 text-sm space-y-5'>
                    <Link to="/" className="font-poppins hover:text-mygreen transition duration-300">ACCUEIL</Link>
                    <Link to="/about" className=" font-poppins hover:text-mygreen transition duration-300">À PROPOS DE</Link>
                    <Link to="/boutique" className=" font-poppins hover:text-mygreen transition duration-300">BOUTIQUE</Link>                    
                    <Link to="/restaurant" className="font-poppins hover:text-mygreen transition duration-300" >RESTAURANT</Link>
                    <Link to="/ngo" className=" font-poppins hover:text-mygreen transition duration-300" >ASSOCIATION</Link>
                    <Link to="/contact" className=" font-poppins hover:text-mygreen transition duration-300" >CONTACT</Link>
                    <div className=''>
                        {isAuth === true ? (                                                    
                            <div className='flex mx-4'>
                                <Link to='/logout' className="block font-poppins text-myorange px-1 py-4 hover:text-mygreen transition duration-300">Logout</Link>
